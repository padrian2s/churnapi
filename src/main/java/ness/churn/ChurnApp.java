...
import ness.churn.config.ApplicationProperties;
import ness.churn.config.DefaultProfileUtil;
...
@EnableZuulProxy
public class ChurnApp {

    private static final Logger log = LoggerFactory.getLogger(ChurnApp.class);

    private final Environment env;

    public ChurnApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(ChurnApp.class);
